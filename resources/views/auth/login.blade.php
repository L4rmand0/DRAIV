            ...
            <div id="login_card">
                ...
                <div class="card-body">
                    <label class="text-center mb-2 mt-2 ml-5"
                        ...
                        una cuenta DRAIV? <a style="color:#1A8ED1; cursor: pointer; font-size: 1em; font-family: 'Fira Sans', sans-serif;"
        ...
        <div class="card col-lg-5" style="background: #EDE6DD;">
            ...
            <div class="card ml-4 mr-4 mt-4 mb-5 border-0">
                ...
                <div class="card-body" id="free_plan">
                    ...
                    <p class="card-text mt-5">Gestione y centralice su información. Visualice dato de conductores,
                        vehículos
                        y licencias de conducción, almacene información documental, valide datos de sus bases de
                        datos
                        vs
                        información extraída de sus documentos digitales.</p>
                ...
                <div class="card-body" id="medium_plan" hidden>
                    <p class="mt-5 text-center"
                        style="color:#4F4F4F; font-weight: 600; font-family: 'Fira Sans', sans-serif; font-size: 5em;">
                        90.000 <strong style="font-size: 0.35em; font-weight: 200; color: #C3C3C3;">$/mes</strong>
                    </p>
                    <p class="card-text mt-5">Gestione y centralice su información. Visualice dato de conductores,
                        vehículos
                        y licencias de conducción.</p>
                    <p class="text-left mt-5" style="margin-bottom: 0 !important; font-weight: 600;">Administración
                        de
                        flotas</p>
                    <hr class="mt-0">
                    <p><i class="fas fa-check" style="color: #4BB996; font-size: 0.8em;"></i> 200 Transacciones
                        (Registro
                        Conductores) por mes</p>
                    <p><i class="fas fa-check" style="color: #4BB996; font-size: 0.8em;"></i> 2 usuario
                        administrador
                        activo
                        por mes</p>
                    <p><i class="fas fa-check" style="color: #4BB996; font-size: 0.8em;"></i> 1 Tablero de análisis
                    ...
                    <p><i class="fas fa-check" style="color: #4BB996; font-size: 0.8em;"></i> 100GB en
                        almacenamientos,
                    ...
                    <p><i class="fas fa-check" style="color: #4BB996; font-size: 0.8em;"></i> 300 consultas de
                        información a
                        bases de terceros (Multas, antecedentes penales)</p>
                ...
                <div class="card-body" id="all_plan" hidden>
                    ...
                    <p class="card-text mt-5">Gestione y centralice su información. Visualice dato de conductores,
                        ...
                        datos
                        vs
                        información extraída de sus documentos digitales. Consulte datos de terceros en tiempo real
                        (Multas,
