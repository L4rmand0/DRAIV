<div class="card" id="card_single_vehicle_skillsM&ID">
    ...
    <div id="collapseItem&ID" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion_skills_moto">
        <div class="card-body">
