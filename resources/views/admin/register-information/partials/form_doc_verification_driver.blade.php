<div class="row mb-3 mt-3">
    ...
    <div class="col-md-3"> <input type="text" class="form-control field_driver_info" name="" id="valid_licence" value=""
    ...
    <div class="col-md-3"><input type="text" class="form-control field_driver_info" name="" id="category" value=""
            data-module="driver-info" readonly>
...
<div class="row mb-3">
    ...
    <div class="col-md-3"><input type="text" class="form-control field_driver_info" name="" id="accident_rate"
