...
@section('content')
<!-- Begin Page Content -->
<input type="hidden" name="route-search-information" id="route-search-information" value="{{ route('edit-driver.search') }}">
        ...
        <div class="card-body">
            <div class="active-pink-3 active-pink-4 mb-4">
                <form id="form_search_information" action="">
                    ...
                    <input class="form-control" type="text" placeholder="Search" aria-label="Search" name="value_param">
                ...
                <div class="card-body">
                    <div class="container-profile mb-4">
                        ...
                        <div class="item-name" style="display: flex;align-items: center;justify-content: center;">
                            <h1 style="margin-bottom:0.3em;margin-top: 0.3em; font-size: 5em;" id="title_name_driver">NOMBRE APELLIDO</h1>
                        </div>
                        <div class="item-id" style="display: flex;align-items: center;justify-content: center;">
                            <p class="p-profile"><strong>ID:</strong> <span id="title_dni_id">1.069.731.531</span></p>
                        </div>
                        <div class="item-tel" style="display: flex;align-items: center;justify-content: center;">
                            <p class="p-profile"><strong>Teléfono:</strong> <span id="title_phone">3024682891</span></p>
                        </div>
                        <div class="item-contact" style="display: flex;align-items: center;justify-content: center;">
                            <p class="p-profile" style="margin-bottom: 1.2em !important;"><strong>Contacto de Emergencia:</strong> <span id="title_phone">3115687902</span></p>
                        </div>
                    ...
                    <nav>
                        <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link a-profile active" id="nav-home-tab" data-toggle="tab"
                                href="#nav-driver-information" role="tab" aria-controls="nav-home" aria-selected="true"><i
