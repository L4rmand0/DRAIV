                        ...
                        <div class="form-card">
                            <div class="row mt-2">
                                <div class="col-md-12 form_select_conductores" id="row-taxi-inputs">
                                    <label for="driver_information_dni_id_images">C.C Conductor</label>
                                    <select name="vehicle[taxi_type]" class="form-control form-vehicles"
                                        id="driver_information_dni_id_images"
                                        data-url="{{ route('drivers-select-lists')}}" style="width: 100%">
        ...
        <div class="col-md-7 mb-4">
            ...
            <div class="card shadow mb-4" id="card_upload_images">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <form method="POST" action="{{ route('images.store') }}" class="form_upload_image" accept-charset="UTF-8" enctype="multipart/form-data" data-key="{{ $item_type_images }}">
                                @csrf
                                ...
                                <div class="custom-file overflow-hidden rounded-pill mb-1">
                                    <input id="customFile" type="file" name="file[{{ $item_type_images }}]"
                                        class="custom-file-input rounded-pill">
                                    <label for="customFile" class="custom-file-label rounded-pill">Seleccionar ...</label>
                                </div>
