<div class="form-card" style="margin-bottom: 50px;">
    <div class="row">
        <div class="col-md-6">
            <input class="form-control form-vehicles text-datadrivers" type="text" name="vehicle[plate_id][]" placeholder="Placa"
                id="plate_id&NUMFORM" data-check="{{ route('admin.vehicle.checkvehiclebyid') }}" onkeyup="this.value = this.value.toUpperCase();"/>
        </div>
        <div class="col-md-6">
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-md-6">
            ...
            <select name="vehicle[type_v][]" class="form-control form-vehicles text-datadrivers" id="type_v&NUMFORM"
                style="width: 100%">
        ...
        <div class="col-md-6">
            ...
            <select name="vehicle[owner_v][]" class="form-control form-vehicles text-datadrivers" id="owner_v&NUMFORM"
    ...
    <div class="row mt-2">
        <div class="col-md-6 form_select_conductores text-datadrivers" id="row-taxi-inputs" hidden>
            ...
            <select name="vehicle[taxi_type][]" class="form-control form-vehicles" id="taxi_type&NUMFORM"
                style="width: 100%">
                <option value="">Seleccionar...</option>
        ...
        <div class="col-md-6 form_select_conductores">
            ...
            <select name="vehicle[number_of_drivers][]" class="form-control form-vehicles text-datadrivers"
                id="number_of_drivers&NUMFORM" style="width: 100%">
                <option value="">Seleccionar...</option>
    ...
    <div class="row row_form_input_vehicle mt-2">
        <div class="col-md-6">
            ...
            <input type="date" class="form-control form-vehicles text-datadrivers date_vehicle" name="vehicle[soat_expi_date][]"
                id="soat_expi_date&NUMFORM" readonly/>
        </div>
        <div class="col-md-6">
            ...
            <input type="date" class="form-control form-vehicles text-datadrivers date_vehicle" name="vehicle[technomechanical_date][]"
                id="technomechanical_date&NUMFORM" readonly />
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-md-6 form_select_conductores">
            <label for="capacity" id="label-capacity">Cantidad de pasajeros</label>
            <select name="vehicle[capacity][]" class="form-control form-vehicles text-datadrivers" id="capacity&NUMFORM"
                style="width: 100%">
                <option value="">Seleccionar...</option>
                <option value="1">1</option>
                <option value="2">2</option>
        ...
        <div class="col-md-6 form_select_conductores">
            ...
            <select name="vehicle[service][]" class="form-control form-vehicles text-datadrivers" id="service&NUMFORM"
                style="width: 100%">
                <option value="">Seleccionar...</option>
    ...
    <div class="row row_form_input_conductores mt-2">
        <div class="col-md-6">
            <input type="text" class="form-control form-vehicles text-datadrivers" name="vehicle[cylindrical_cc][]"
                id="cylindrical_cc&NUMFORM" placeholder="Cilindraje" />
        </div>
        <div class="col-md-6">
            <input type="text" class="form-control form-vehicles text-datadrivers" name="vehicle[v_class][]" id="v_class&NUMFORM"
    ...
    <div class="row row_form_input_conductores mt-2">
        <div class="col-md-6">
            <input type="number" class="form-control form-vehicles text-datadrivers" name="vehicle[model][]" min="1950" max="2030"
                placeholder="Modelo (año)" id="model&NUMFORM" />
        </div>
        <div class="col-md-6">
