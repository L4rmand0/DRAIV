<div class="card" id="card-form-vehicles">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="d-flex justify-content-center mt-1">
                    <input type="submit" value="Subir" class="btn btn-primary btn_images_vehicle"
                        data-key="{{ $item_type_images }}">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="d-flex justify-content-center mt-1">
                <input type="submit" value="Subir" class="btn btn-primary btn_images_drivers"
                    data-key="{{ $item_type_images }}">
            </div>
    ...
    <div class="col-md-4">
        <label for="customFile" class="text-secondaty ml-2"> {{ $type_images_key }} </label>
        <div class="custom-file overflow-hidden rounded-pill mb-1">
            <input id="file{{$item_type_images}}" type="file" name="file[{{$item_type_images}}]" style="cursor:pointer;"
