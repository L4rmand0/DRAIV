<div class="form-card">
    <h2 class="fs-title mt-2">Verificación Manual de Documentación</h2>
    <div class="row">
        <div class="col-md-6">
            <label for="code_penality_5_form">Vehículo</label><br>
            <select class="form-control select_user_vehicle" name="user_vehicle_id" id="user_vehicle_id_form"
